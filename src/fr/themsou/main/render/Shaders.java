...
public class Shaders {
	...
	public static final Shaders MAIN = new Shaders("/shaders/main.vert", "/shaders/main.frag");
	public int program;
	...
	public Shaders(String vert, String frag){
		...
		createShader(loadShader(vert), GL_VERTEX_SHADER);
		createShader(loadShader(frag), GL_FRAGMENT_SHADER);
	...
	private String loadShader(String uri){
		
		String r = "";
		
		InputStream is = Shaders.class.getResourceAsStream(uri);
